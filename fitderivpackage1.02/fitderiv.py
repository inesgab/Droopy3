...
class fitderiv:
    ...
    def __init__(self, t, d, cvfn= 'sqexp', noruns= 5, exitearly= False, figs= False, bd= False,
                 ...
                 showstaterrors= False, warn= False, linalgmax= 3):
        '''
    ...
    def plotfit(self, char= 'f', errorfac= 1, xlabel= 'time', ylabel= False, figtitle= False, color = 'b'):
        '''
    ...
    def calculatestats(self, nosamples= 100, statnames= False, showerrors= False):
        '''
        ...
        if showerrors: 
            ...
            print('\t(displaying mean +/- standard deviation [standard error])\n')
        if statnames:
        ...
        self.printstats(showerrors= showerrors, performprint=showerrors)



    def printstats(self, errorfac= 1, showerrors= False, performprint= False):
        '''
